...
import { Badge, Empty } from "@frontend/components/shared/presentation";
              ...
              <p className="lrn-copy">
                {verified
                  ...
                  : data.canVerify
                    ...
                    : data.masteryRemaining === 0
                      ? "Mastery threshold reached. Complete the remaining verification requirements."
                      : `${data.masteryRemaining} more points to reach the mastery threshold.`}
              </p>
