...
let service: typeof import("@backend/services/learning");
let career: typeof import("@backend/services/employee.service");
...
beforeAll(async () => {
  ...
  service = await import("@backend/services/learning");
  career = await import("@backend/services/employee.service");
...
describe("Persisted verified development journeys", () => {
  ...
  it("opening and consuming content never awards skills; legacy completion is blocked", async () => {
    ...
    await expect(
      activityService.recordActivity("LEARNER", "EV017", "COMPLETED"),
