let activityService: typeof import("@backend/services/activity.service");
...
let services: typeof import("@backend/services/employee.service");
let importer: typeof import("@backend/services/import.service");
...
beforeAll(async () => {
  ...
  const migrations = new URL("../../data/prisma/migrations/", import.meta.url);
  ...
  activityService = await import("@backend/services/activity.service");
  services = await import("@backend/services/employee.service");
  importer = await import("@backend/services/import.service");
...
describe("Persistent career state", () => {
  it("rejects legacy one-click completion without changing skill or readiness", async () => {
    await expect(
      activityService.recordActivity("EMP001", "EV017", "COMPLETED"),
